...
<!-- Mirrored from pages.revox.io/dashboard/latest/html/corporate/datatables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Nov 2020 09:06:24 GMT -->
<!-- Added by HTTrack -->
...
<body class="fixed-header menu-pin menu-behind">
  ...
  <nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <ul class="menu-items">
          <li class="m-t-20 ">
            <a href="/smartphone/admin.php" class="detailed">
          ...
          <li class="">
            <a href="/smartphone/product.php" class="detailed">
              <span class="title">Product</span>
            </a>
            <span class="icon-thumbnail"><i class="pg-icon">inbox</i></span>
          </li>
          <li class="">
            <a href="/smartphone/category.php"><span class="title">Category</span></a>
            <span class="icon-thumbnail"><i class="pg-icon">social</i></span>
          </li>
          <li>
            <a href="javascript:;"><span class="title">Order</span>
    ...
    <div class="header ">
      ...
      <div class="">
        <div class="brand inline  m-l-10 ">
          <img src="./img/logo2.png" alt="logo" data-src="./img/logo2.png"" data-src-retina="./img/logo2.png"" width="78" height="22">
        </div>
        ...
        <a href="#" class="search-link d-lg-inline-block d-none" data-toggle="search"><i class="pg-icon">search</i>Type anywhere to <span class="bold">search</span></a>
      </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header clearfix ">
                ...
                <h4 class="p-b-5"><span class="semi-bold">New</span> Product</h4>
              </div>
              <?php
              ...
              <div class="modal-body">
                <p class="">Create a new product now</p>
                <form method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-sm-12">
                      <label>Product Name</label>
                      <div class="form-group form-group-default">
                        <input id="appName" name="txtName" type="text" class="form-control" placeholder="Name of your product">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group form-group-default">
                        <input id="appDescription" type="text" name="txtDesc" class="form-control" placeholder="Description...">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <label>Price</label>
                      <div class="form-group form-group-default">
                        <input id="appPrice" type="text" name="txtPrice" class="form-control" placeholder="Your price">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <label>Quantity</label>
                      <div class="form-group form-group-default">
                        <input id="appNotes" type="text" name="txtQuantity" class="form-control" placeholder="Quantity....">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group form-group-default">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group form-group-default">
                          <input class="form-control" type="file" name="txtPic" value="<?php echo $item["Picture"]?>" accept=".PNG,.GIF,.JPG">
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class=" container-fluid   container-fixed-lg">
          ...
          <div class="card card-transparent">
            <div class="card-header ">
              <div class="card-title">Table with Category
              </div>
              <div class="pull-right">
                <div class="col-xs-12">
                  <button aria-label="" id="show-modal" class="btn btn-primary btn-cons"><i class="pg-icon">add</i> Add Product
                  </button>
                </div>
                  ...
                  ?>
                    <td class="v-align-middle">
                      <div class="form-check d-flex align-items-center justify-content-center">
                        ...
                        <button aria-label="" class="btn btn-link"><a href="./delete.php/<?php echo $item["ProductID"] ?>"><i class="pg-icon">trash_alt</i></a>
                        </button>
                        <button class="btn btn-link" data-toggle="modal" data-target="#<?php echo"Modal".$item["ProductID"] ?>"">
  ...
  <div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
      ...
      <div class="container-fluid">
        <!-- BEGIN Overlay Logo !-->
        <img class="overlay-brand" src="./img/logo2.png" alt="logo" data-src="./img/logo2.png" data-src-retina="./img/logo2.png" width="78" height="22">
        <!-- END Overlay Logo !-->
        <!-- BEGIN Overlay Close !-->
  ...
  <script src="../../../../../www.gstatic.com/firebasejs/7.24.0/firebase-performance.js"></script>
...
<!-- Mirrored from pages.revox.io/dashboard/latest/html/corporate/datatables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Nov 2020 09:06:25 GMT -->
